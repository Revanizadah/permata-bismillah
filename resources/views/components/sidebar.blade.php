<div class="w-64 bg-gray-800 text-white p-6 min-h-screen">
    ...
    <ul class="space-y-4">
        ...
        <li>
            <a href="{{ route('manage-pesanan.index') }}" class="flex items-center text-gray-300 hover:text-white hover:bg-gray-700 px-4 py-2 rounded-lg">
                <i class="fas fa-list w-5 h-5 mr-3"></i>
                Pesanan
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('pesanan-offline.index') }}"class="flex items-center text-gray-300 hover:text-white hover:bg-gray-700 px-4 py-2 rounded-lg">
                <i class="fas fa-paperclip w-5 h-5 mr-3"></i>
