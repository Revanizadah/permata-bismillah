<footer class="bg-white text-white pt-16 pb-6">
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-500 hover:text-black transition">Beranda</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-black transition">Tentang Kami</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-black transition">Pesan Lapangan</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-black transition">Riwayat Pesanan</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    <a href="#" class="text-gray-500 hover:text-black transition text-2xl"><i class="fab fa-facebook-f"></i></a>
                    <a href="#" class="text-gray-500 hover:text-black transition text-2xl"><i class="fab fa-instagram"></i></a>
                    <a href="#" class="text-gray-500 hover:text-black transition text-2xl"><i class="fab fa-twitter"></i></a>
                    <a href="#" class="text-gray-500 hover:text-black transition text-2xl"><i class="fab fa-whatsapp"></i></a>
                </div>
            </div>
